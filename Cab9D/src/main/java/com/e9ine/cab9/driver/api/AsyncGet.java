...
public abstract class AsyncGet<T> extends AsyncTask<Long, Void, WrappedApiResult<ArrayList<T>>> {

	public SimpleArrayMap<String, String> mQueryValues = new SimpleArrayMap<String, String>();

	@Override
	protected final WrappedApiResult<ArrayList<T>> doInBackground(Long... params) {
		...
		try {
			...
			switch (HttpStatusCode) {
				case HttpStatus.SC_UNAUTHORIZED:
					return new WrappedApiResult<ArrayList<T>>(WrappedApiResult.UNAUTHORIZED_CODE);
				case HttpStatus.SC_INTERNAL_SERVER_ERROR:
					return new WrappedApiResult<ArrayList<T>>(WrappedApiResult.SERVER_ERROR_CODE);
				case HttpStatus.SC_NOT_FOUND:
					return new WrappedApiResult<ArrayList<T>>(WrappedApiResult.NOT_FOUND_CODE);
				case HttpStatus.SC_BAD_REQUEST:
					return new WrappedApiResult<ArrayList<T>>(WrappedApiResult.BAD_REQUEST_CODE);
				case HttpStatus.SC_OK:
					break;
				default:
					return new WrappedApiResult<ArrayList<T>>(WrappedApiResult.OTHER_ERROR_CODE);
			}
		...
		return new WrappedApiResult<ArrayList<T>>(result);
	}

	@Override
	protected void onPostExecute(WrappedApiResult<ArrayList<T>> response) {
		if (response.Success) {
	...
	protected abstract void onResultReturned(ArrayList<T> result);
